...
app.main = (_app$main = {
	...
	scene: false,
	titleScreen: true
}, _defineProperty(_app$main, 'endingState', false), _defineProperty(_app$main, 'changed', false), _defineProperty(_app$main, 'sceneNum', 0), _defineProperty(_app$main, 'battle', 0), _defineProperty(_app$main, 'camX', 1), _defineProperty(_app$main, 'camY', 1), _defineProperty(_app$main, 'trueEnding', false), _defineProperty(_app$main, 'savesGohan', 0), _defineProperty(_app$main, 'blasts', undefined), _defineProperty(_app$main, 'blinking', 0), _defineProperty(_app$main, 'pulsing', 0), _defineProperty(_app$main, 'warnings', 0), _defineProperty(_app$main, 'sceneCounter', 0), _defineProperty(_app$main, 'sceneTimer', 0), _defineProperty(_app$main, 'damageTimer', 0), _defineProperty(_app$main, 'instructions', 0), _defineProperty(_app$main, 'sceneChange', 0), _defineProperty(_app$main, 'modeSwitch', 0), _defineProperty(_app$main, 'modeSwitch17', 0), _defineProperty(_app$main, 'cooldownAI', 0), _defineProperty(_app$main, 'cooldownAI2', 0), _defineProperty(_app$main, 'cooldownAI3', 0), _defineProperty(_app$main, 'cooldownAndroid17', 0), _defineProperty(_app$main, 'cooldownAndroid18', 0), _defineProperty(_app$main, 'changeDelay', 0), _defineProperty(_app$main, 'GI', false), _defineProperty(_app$main, 'HM', false), _defineProperty(_app$main, 'IB', false), _defineProperty(_app$main, 'CP', false), _defineProperty(_app$main, 'SB', false), _defineProperty(_app$main, 'BH', false), _defineProperty(_app$main, 'FR', false), _defineProperty(_app$main, 'EF', false), _defineProperty(_app$main, 'BA', false), _defineProperty(_app$main, 'IR', false), _defineProperty(_app$main, 'PE', false), _defineProperty(_app$main, 'BB', false), _defineProperty(_app$main, 'BR', false), _defineProperty(_app$main, 'ES', false), _defineProperty(_app$main, 'LG', false), _defineProperty(_app$main, 'AI', false), _defineProperty(_app$main, 'ER', false), _defineProperty(_app$main, 'AB', false), _defineProperty(_app$main, 'SF', false), _defineProperty(_app$main, 'EE', false), _defineProperty(_app$main, 'NR', false), _defineProperty(_app$main, 'DB', false), _defineProperty(_app$main, 'HZ', false), _defineProperty(_app$main, 'SC', false), _defineProperty(_app$main, 'MS', false), _defineProperty(_app$main, 'DD', false), _defineProperty(_app$main, 'powerModule', false), _defineProperty(_app$main, 'temporalModule', false), _defineProperty(_app$main, 'aegisChip', false), _defineProperty(_app$main, 'synchronousChip', false), _defineProperty(_app$main, 'mindCircuit', false), _defineProperty(_app$main, 'masteryCircuit', false), _defineProperty(_app$main, 'dataOfPiccolo', false), _defineProperty(_app$main, 'dataOfVegeta', false), _defineProperty(_app$main, 'dataOfGohan', false), _defineProperty(_app$main, 'dataOfTien', false), _defineProperty(_app$main, 'dataOfKrillin', false), _defineProperty(_app$main, 'whatLoot', undefined), _defineProperty(_app$main, 'vegetaDying', false), _defineProperty(_app$main, 'piccoloDying', false), _defineProperty(_app$main, 'gohanDying', false), _defineProperty(_app$main, 'dying18', false), _defineProperty(_app$main, 'vegetaDead', false), _defineProperty(_app$main, 'piccoloDead', false), _defineProperty(_app$main, 'gohanDead', false), _defineProperty(_app$main, 'krillinDead', false), _defineProperty(_app$main, 'tienDead', false), _defineProperty(_app$main, 'yamchaDead', false), _defineProperty(_app$main, 'chaotzuDead', false), _defineProperty(_app$main, 'fpsBack', 20), _defineProperty(_app$main, 'lastExecutionBack', undefined), _defineProperty(_app$main, 'init', function init() {
     		...
     		if(this.android18.attacking == false || hardAttackHitTest(this.android18, this.vegeta) != true){
     			this.vegeta.blocking = false;
					...
					if (this.vegeta.vegeta == true) {
						...
						//VEGETA BLOCKING -- FOCUS 17
						if (this.aiChoice3 < .6 && this.aiChoice3 > .2 && this.vegeta.fight == false && this.vegeta.taunting == false && this.vegeta.exhausted == false && this.vegeta.end == false && hardAttackHitTest(this.android17, this.vegeta) == true && this.vegeta.gero == false) {
							if (this.action == false) {
								this.action = true;
								this.aiChoice3 = 10;
								this.vegeta.blocking = true;
   ...
   this.changed = false; */
     ...
     this.environment.decay = true; */
			...
			if (this.sceneNum == 4 && this.battle == 2 && this.trueEnding == true) {
				...
				} else if (this.sceneTimer < 241 && this.sceneTimer > 239) {
		...
		if (this.scene == false || this.gameState == this.GAME_STATE.TUTORIAL) {
			if (app.main.vegeta.air == false && app.main.android18.air == true || app.main.vegeta.air == true && app.main.android18.air == false) {
				if (app.main.vegeta.position.x < app.main.android18.position.x - 140) {
					...
					if ((this.vegeta.stun != true || this.vegeta.superSpeed == true) && this.android18.superSpeed != true && this.vegeta.hard != true && (this.vegeta.blasting != true || this.vegeta.piccolo == true) && this.vegeta.end != true && this.vegeta.focus17 == false) {
			...
			if (app.main.vegeta.air == false && app.main.android17.air == true || app.main.vegeta.air == true && app.main.android17.air == false) {
				if (app.main.vegeta.position.x < app.main.android17.position.x - 140) {
					...
					if ((this.vegeta.stun != true || this.vegeta.superSpeed == true) && this.android17.superSpeed != true && this.vegeta.hard != true && (this.vegeta.blasting != true || this.vegeta.piccolo == true) && this.vegeta.end != true && this.vegeta.focus17 == true) {
						app.main.vegeta.left = false;
						app.main.vegeta.right = true;
					}
 ...
 */
  ...
  ctx.restore(); */
	...
	if (this.gameState == this.GAME_STATE.DEFAULT || this.gameState == this.GAME_STATE.TUTORIAL) {
		...
		if (this.vegeta.vegeta == true && this.vegeta.vanish == false && this.target == true) {
			...
			this.fillText(ctx, "Target: All Humans", 130, 40, "20pt heavy_data", "#c9be03");
		} else {
			this.fillText(ctx, "Target: Undecided", 130, 40, "20pt heavy_data", "#c9be03");
		}
		...
		if (this.gameState == this.GAME_STATE.TUTORIAL) {
			...
			if (this.toggle2 == false) {
				...
				this.fillText(ctx, "Enter to end", this.WIDTH / 2 + 400, 367, "16pt heavy_data", "#c9be03");
				this.fillText(ctx, "'T': Toggle Tutorials", this.WIDTH / 2 + 400, 390, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "Controls", this.WIDTH / 2 + 400, 335, "32pt heavy_data", "#c9be03");
				this.fillText(ctx, "Controls", this.WIDTH / 2 + 400, 335, "32pt heavy_data", "white");
				this.fillText(ctx, "'A': Basic Attack", this.WIDTH / 2 + 400, 410, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'S': Energy Attack", this.WIDTH / 2 + 400, 430, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'Q': Super Speed", this.WIDTH / 2 + 400, 450, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'E': Taunt", this.WIDTH / 2 + 400, 470, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'W': Block", this.WIDTH / 2 + 400, 490, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'D A': Strong Attack", this.WIDTH / 2 + 400, 510, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'D S': Powerful Energy", this.WIDTH / 2 + 400, 530, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'D W': Android Barrier", this.WIDTH / 2 + 400, 550, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'P': Pause", this.WIDTH / 2 + 400, 570, "12pt heavy_data", "#c9be03");
				this.fillText(ctx, "'Arrow Keys': Move Or Fly", this.WIDTH / 2 + 400, 590, "12pt heavy_data", "#c9be03");
			}
			...
			if (this.toggle1 == false) {
				...
				this.fillText(ctx, "TUTORIAL MODE", this.WIDTH / 2, 385, "32pt heavy_data", "#c9be03");
				this.fillText(ctx, "TUTORIAL MODE", this.WIDTH / 2, 385, "32pt heavy_data", "white");
				...
				this.fillText(ctx, this.instructions + 1 + " OF 23", this.WIDTH / 2 + 15, 515, "16pt heavy_data", "white");
				if (this.instructions == 0) {
					this.fillText(ctx, "Lets begin the testing my androids", this.WIDTH / 2, 425, "24pt heavy_data", "#c9be03");
					...
					this.fillText(ctx, "Interface Meters", this.WIDTH / 2, 445, "48pt heavy_data", "#c9be03");
					...
					this.fillText(ctx, "Movement", this.WIDTH / 2, 445, "48pt heavy_data", "#c9be03");
					...
					this.fillText(ctx, "Battle Controls ", this.WIDTH / 2, 445, "48pt heavy_data", "#c9be03");
					...
					this.fillText(ctx, "Important Facts", this.WIDTH / 2, 445, "48pt heavy_data", "#c9be03");
  ...
  ctx.restore(); */
	...
	if (this.gameState == this.GAME_STATE.VICTORY) {
		...
		if (this.trueEnding == true) {
			this.fillText(this.ctx, "The Beginning?", this.WIDTH / 2, this.HEIGHT / 2 - 120, "50pt heavy_data", "#c9be03");
			this.fillText(this.ctx, "The Beginning?", this.WIDTH / 2, this.HEIGHT / 2 - 120, "50pt heavy_data", "white");
		} else {
			this.fillText(this.ctx, "The End?", this.WIDTH / 2, this.HEIGHT / 2 - 120, "50pt heavy_data", "#c9be03");
			this.fillText(this.ctx, "The End?", this.WIDTH / 2, this.HEIGHT / 2 - 120, "50pt heavy_data", "white");
		}
     ...
     */
				...
				if (this.air == true) {
					...
					if (this.stunCounter > 10) {
						...
						this.dead = true;
						if (this.stunCounter == 11) {
							app.main.sound.playTaunt7(getRandom(15, 16));
						}
					}
				}
			}
